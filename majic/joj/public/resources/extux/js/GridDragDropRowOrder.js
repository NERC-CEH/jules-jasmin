    ...
    onGridRender : function (grid)
    {
        ...
        this.target = new Ext.dd.DropTarget(grid.getEl(),
        {
            ...
            notifyDrop: function(dd, e, data)
            {
                ...
                {
                    this.currentRowEl.removeClass('x-grid-row-insert-below');
                    this.currentRowEl.removeClass('x-grid-row-insert-above');
                }
                ...
                */
                ...
                {
                    // Find the first unhidden column.
                    colModel = sm.grid.getColumnModel();
                    displayColumn = 0;
                    ...
                    for (var i = 0; i < data.selections.length; i++)
                    {
                        // alert(ds.indexOfId(data.selections[i].id));
                        sm.select(ds.indexOfId(data.selections[i].id), displayColumn);
                    }
                }
            ...
            notifyOver: function(dd, e, data)
            {
                ...
                try
                {
                    ...
                    if (this.rowPosition > 0)
                    {
                        ...
                        this.currentRowEl.addClass('x-grid-row-insert-below');
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            this.currentRowEl.addClass('x-grid-row-insert-above');
                        }
                    }
                }
                catch (err)
