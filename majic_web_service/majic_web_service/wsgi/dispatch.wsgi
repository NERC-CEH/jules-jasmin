...
fileConfig('/var/local/majic_ws/jules-jasmin/majic_web_service/production.ini')
...
application = loadapp('config:/var/local/majic_ws/jules-jasmin/majic_web_service/production.ini')
