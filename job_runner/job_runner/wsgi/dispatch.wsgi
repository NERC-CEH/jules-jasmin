...
fileConfig('/var/local/job_runner/jules-jasmin/job_runner/production.ini')
...
application = loadapp('config:/var/local/job_runner/jules-jasmin/job_runner/production.ini')
