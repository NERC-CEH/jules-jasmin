...
def convert1Din2D(inputFolder,outputFolder,inputFileName,verbose=False):
    ...
    setattr(outnc, 'creator_name', 'Simon Wright, Maliko Tanguy')
    setattr(outnc, 'creator_url', 'http://www.ceh.ac.uk/staffwebpages/simonwright.html')
    setattr(outnc, 'creator_email', 'smw@ceh.ac.uk, malngu@ceh.ac.uk')
...
if __name__ == '__main__':
    ...
    outputFolder = '/prj/lwis/maliko/JULES_JASMIN/'
